...
const AssignmentsTableRow = ({ assignment, assignments }) => {
  const { title, video_title, totalMark, id, video_id } = assignment || {};
  ...
  const [deleteAssignment, { isSuccess: isDeleteVideoSuccess }] =
